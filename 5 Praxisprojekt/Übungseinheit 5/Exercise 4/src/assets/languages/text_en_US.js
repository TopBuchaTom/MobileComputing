...
const work = {
  pageheader: 'Work',
  day_tabheader: 'Day',
  location_tabheader: 'Location',
  details_header: 'Work details',
  emptylist_text: 'The list is currently empty. Add a new tak by clicking the + button.',
  menu_edit_link: 'Edit',
  menu_location_link: 'Location',
  deletework_header: 'Delete work?',
  deletework_details: `
    Are you sure that you want to delete all entries of the personal worklist?<br/><br/>
    If you want to delete only a specific entry, you can do it by swiping the respective worklist entry.
  `,
  deleteworkentry_header: 'Delete worklist entry?',
  deleteworkentry_details: `
    Are you sure you want to remove this entry from your personal schedule?
  `,
}
