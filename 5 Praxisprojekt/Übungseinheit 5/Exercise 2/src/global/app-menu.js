...
import { homeOutline, settingsOutline, informationCircleOutline, searchOutline } from "ionicons/icons";
      ...
      <ion-content>
        ...
        <ion-list>
          <ion-menu-toggle>
            ...
            <ion-router-link href="/#/${SearchPage.name}">
              <ion-item>
                <ion-icon icon=${searchOutline} slot="start"></ion-icon>
                <ion-label>${L.text.menu.search_link}</ion-label>
              </ion-item>
            </ion-router-link>
            <br/>
